...
import { ChevronRight, MessageCircle, PawPrint } from 'lucide-react';
          ...
          <div className="mt-5 divide-y divide-slate-100">
            {realPets.map((pet) => {
              ...
              return (
                ...
                >
                  <div className="relative flex size-12 shrink-0 items-center justify-center overflow-hidden rounded-full bg-slate-100">
                    {imageSource ? (
                      <Image
                        src={imageSource}
                        alt={pet.name}
                  ...
                  <ChevronRight className="size-5 text-slate-400 transition-transform group-hover:translate-x-0.5" aria-hidden="true" />
                </button>
              );
            })}
          </div>
